...
import { bindGroupNames, FRONTFACE_CCW, FRONTFACE_CW, PRIMITIVE_LINESTRIP, PRIMITIVE_TRISTRIP } from '../constants.js';
...
class WebgpuRenderPipeline extends WebgpuPipeline {
     ...
     * @param {number} frontFace - The front-facing winding ({@link FRONTFACE_CCW} or {@link FRONTFACE_CW}).
    ...
    get(primitive, vertexFormat0, vertexFormat1, ibFormat, shader, renderTarget, bindGroupFormats, blendState,
        depthState, cullMode, frontFace, stencilEnabled, stencilFront, stencilBack) {
        ...
        cacheEntry.pipeline = this.create(primitiveTopology, ibFormat, shader, renderTarget, pipelineLayout, blendState,
            depthState, vertexBufferLayout, cullMode, frontFace, stencilEnabled, stencilFront, stencilBack);
    ...
    create(primitiveTopology, ibFormat, shader, renderTarget, pipelineLayout, blendState, depthState, vertexBufferLayout,
        cullMode, frontFace, stencilEnabled, stencilFront, stencilBack) {
        ...
        Debug.assert(frontFace === FRONTFACE_CCW || frontFace === FRONTFACE_CW);
        ...
        const desc = {
            ...
            primitive: {
                ...
                frontFace: _frontFaces[frontFace],
